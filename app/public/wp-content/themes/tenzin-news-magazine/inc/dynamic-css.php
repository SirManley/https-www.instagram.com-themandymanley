 ...
 * Dynamic CSS
 */
function tenzin_news_magazine_dynamic_css() {

	$header_font           = get_theme_mod( 'tenzin_news_magazine_header_font', 'Fira Sans' );
	$body_font             = get_theme_mod( 'tenzin_news_magazine_body_font', 'Merriweather' );
	$site_title_font       = get_theme_mod( 'tenzin_news_magazine_site_title_font', 'Fira Sans' );
	$site_description_font = get_theme_mod( 'tenzin_news_magazine_site_description_font', 'Roboto' );
...
add_action( 'wp_enqueue_scripts', 'tenzin_news_magazine_dynamic_css', 99 );
